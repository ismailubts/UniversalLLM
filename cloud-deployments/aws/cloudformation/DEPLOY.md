...
5. Use the file `cloudformation_create_universalllm.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_universal-llm  Created 
 ⠿ Container universal-llm       Started  
```
