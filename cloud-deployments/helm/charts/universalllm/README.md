...
![UniversalLLM](https://raw.githubusercontent.com/ismailubts/UniversalLLM/main/images/wordmark.png)

[UniversalLLM](https://github.com/ismailubts/UniversalLLM)
...
```yaml
image:
  repository: ismailubts/universalllm
  tag: "1.15.0"
...
```
helm install my-universalllm ./universalllm -f values-secret.yaml
```
...
| image.repository | string | `"ismailubts/universalllm"` |  |
