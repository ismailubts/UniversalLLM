...
const doc = {
  info: {
    version: "1.0.0",
    title: "UniversalLLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your UniversalLLM instance. UI supplied by Swagger.io.",
  },
