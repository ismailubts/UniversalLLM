...
class AgentHandler {
  ...
  #getFallbackProvider() {
    ...
    if (this.invocation.workspace.chatProvider === "universalllm-router") {
      return { provider: "universalllm-router", model: null };
    }
    ...
    if (systemProvider === "universalllm-router") {
      return { provider: "universalllm-router", model: null };
    }
  ...
  async #providerSetupAndCheck() {
    ...
    if (this.provider === "universalllm-router") {
