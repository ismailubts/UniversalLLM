...
const Workspace = {
  ...
  update: async function (id = null, updates = {}) {
    ...
    // When switching to universalllm-router, chatModel is not used.
    // When switching away from universalllm-router, clear router_id.
    if (validatedUpdates?.chatProvider === "universalllm-router") {
      validatedUpdates.chatModel = null;
    } else if (
      validatedUpdates?.chatProvider &&
      validatedUpdates.chatProvider !== "universalllm-router"
    ) {
  ...
  supportsNativeToolCalling: async function (workspace = {}) {
    ...
    if (provider === "universalllm-router") {
