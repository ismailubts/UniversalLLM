...
Write-Host "  https://cdn.universalllm.com/support/open-computer/base-images/<DATE>/$TarName"
Write-Host "  https://cdn.universalllm.com/support/open-computer/base-images/<DATE>/$ShaName"
