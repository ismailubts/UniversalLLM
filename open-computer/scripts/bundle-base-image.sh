...
echo "  https://cdn.universalllm.com/support/open-computer/base-images/<DATE>/$TAR_NAME"
echo "  https://cdn.universalllm.com/support/open-computer/base-images/<DATE>/$SHA_NAME"
