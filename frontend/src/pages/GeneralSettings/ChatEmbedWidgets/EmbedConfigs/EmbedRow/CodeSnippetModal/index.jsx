...
https://github.com/ismailubts/universalllm-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/UniversalLLM-chat-widget.min.js">
</script>
<!-- UniversalLLM (#) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/ismailubts/universalllm-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
