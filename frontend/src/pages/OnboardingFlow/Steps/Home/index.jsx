...
export default function OnboardingHome() {
  ...
  return (
    <div className="relative w-screen h-screen flex flex-col overflow-hidden bg-zinc-950 light:bg-slate-50">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center pt-[58px] gap-1">
        <p className="text-white/90 light:text-slate-700 text-3xl font-semibold tracking-tight">
          UniversalLLM
        </p>
        <p className="text-white/60 light:text-slate-500 text-sm font-medium tracking-wide">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center -mt-8">
        ...
        <button
          ...
          className="relative border-none z-10 h-[40px] w-[300px] py-2.5 px-5 rounded-xl bg-slate-50 hover:bg-slate-300 font-medium text-sm mt-[42px] text-zinc-900 light:text-white light:bg-slate-900 light:hover:bg-slate-800 text-center flex justify-center items-center transition-colors duration-200 shadow-sm"
        >
