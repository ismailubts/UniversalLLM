    ...
    <>
      ...
      >
        ...
        <div className="overflow-hidden h-full">
          ...
          <div
            ref={sidebarRef}
            className="relative m-[16px] rounded-[16px] bg-theme-bg-sidebar light:bg-slate-200 border border-theme-sidebar-border light:border-slate-200/80 min-w-[250px] p-[10px] h-[calc(100%-76px)] shadow-xl shadow-indigo-500/5 ring-1 ring-white/5 light:shadow-slate-200/60"
          >
          ...
          <div className="w-full h-full flex flex-col overflow-x-hidden items-between">
            ...
            <div className="h-full flex flex-col w-full justify-between pt-4 ">
              <div className="h-auto md:sidebar-items">
                <div className=" flex flex-col gap-y-4 overflow-y-scroll no-scroll pb-4">
                  <NewWorkspaceButton
                    user={user}
