...
const SHOW_METRICS_KEY = "universalllm_show_chat_metrics";
const SHOW_METRICS_EVENT = "universalllm_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `universalllm_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `universalllm_show_chat_metrics` key
 * @returns {void}
 */
