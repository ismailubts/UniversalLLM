import UniversalLLMIcon from "@/media/logo/universal-llm.svg";
...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of UniversalLLM.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "UniversalLLM Embedder",
    description: [
      "Your document text is embedded privately on this instance of UniversalLLM.",
    ],
    logo: UniversalLLMIcon,
  },
  openai: {
    name: "OpenAI",
    policyUrl: "https://openai.com/policies/privacy-policy/",
