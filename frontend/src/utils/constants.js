...
export const AUTH_USER = "universalllm_user";
export const AUTH_TOKEN = "universalllm_authToken";
export const AUTH_TIMESTAMP = "universalllm_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "universalllm_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "universalllm_pinned_document_alert";
export const SEEN_WATCH_ALERT = "universalllm_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "universalllm_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "universalllm_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "universalllm_pending_home_message";

export const APPEARANCE_SETTINGS = "universalllm_appearance_settings";
