...
export default {
  ...
  github: () => {
    return "https://github.com/ismailubts/UniversalLLM";
  },
  discord: () => {
    return "#";
  },
  docs: (path = "") => {
    const base =
      "https://github.com/ismailubts/UniversalLLM/blob/master/README.md";
    return path ? `${base}#configuration-guide` : base;
  },
  chatModes: () => {
    return "#";
  },
  mailToSupport: () => {
    return "https://github.com/ismailubts/UniversalLLM/issues";
  },
  hosting: () => {
    return "#";
  },
  ...
  // Documentation links point to the UniversalLLM README on GitHub.
  documentation: {
    mobileIntroduction: () => {
      return "https://github.com/ismailubts/UniversalLLM#installation";
    },
    contextWindows: () => {
      return "https://github.com/ismailubts/UniversalLLM#configuration-guide";
    },
  },
