import * as TTS from "piper-tts-web";

/** @type {import("piper-tts-web").TtsSession | null} */
 ...
 * @property {import('piper-tts-web').VoiceId} voiceId - the voiceID key to use.
 ...
 * @property {('voices')} type
 * @property {[import("piper-tts-web/dist/types")['Voice']]} voices - available voices in array
 */
